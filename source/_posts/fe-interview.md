title: "前端笔试面试问题汇总"
date: 2015-05-09 00:04:08
categories: 整理
tags: [前端,面试,HTML,JavaScript,CSS]
toc: true
---

最近也要开始疯狂地找工作了，虽然导师那边是不让出去实习，不过该准备还得准备。。。毕竟刚刚入门，想要找个好工作还得往死里啃题。 。 。好在有个巨人的肩膀可以站在上边，就是这个俺们的一个学长整理的前端面试题，其实几乎已经很全了，貌似学长本身工作也是忙吧也几乎没有更新···于是乎我再从各大网站论坛上完善补充一下~~持续更新。。。
<!--more-->
...
![排序算法比较](https://raw.githubusercontent.com/geniuspeng/FE-interview/master/img/sort-compare.png)
...
### 浏览器缓存
参考![浏览器缓存机制](http://www.cnblogs.com/skynet/archive/2012/11/28/2792503.html)
