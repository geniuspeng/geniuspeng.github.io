title: "前端开发知识结构"
date: 2015-05-05 22:58:02
categories: 整理
tags: [前端,知识结构]
---

费了几个晚上总算是把这个窝建好了~~~此窝由[Hexo](http://hexo.io/)强力驱动，搭载的是litten大神的[Yilia](https://github.com/litten/hexo-theme-yilia)主题。不过自己稍做了些修改--由于本身自带一些伪宅属性，于是把背景改成了动漫风，再有就是[Yilia](https://github.com/litten/hexo-theme-yilia)主题是本简约风格，我随便加了一些奇怪的东西，当然还想加一些更奇怪的东西，以后有精力的时候再弄吧。
废话讲完，第一篇正式的文章就当个搬运工好了。 。 。而且我觉得这东西对我来说也是很重要。。。由JacksonTian整理的“前端开发知识结构”
...
原地址请戳[FKS](https://github.com/JacksonTian/fks)~~~~前端技术还在飞速发展，当然这些内容也会不断更新
另外附上一个我邮前端大牛学长整理的 [前端入门之路- -](https://github.com/qiu-deqing/FE-learning)